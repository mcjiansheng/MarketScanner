...
> Production implementation SHA: `981ff4e208f74c8d4dd451d32df88233089e3201`
...
The first independent read-only review rejected the earlier test-only evidence because T10/T11/T12/T14 did not exercise the required integration boundaries. Production implementation `14f2b45fb23b9485e1065d1faf572de51dfae909` and test commit `e6c2959f7eae3b0b9feb81b35ce5364effbcaca1` closed those gaps. The second review then rejected missing end-to-end timeout/weak/cooldown state paths. Reducer implementation `218f3ef69a5b68e3e317a4300ed76dd606cb531e` and test commit `90d0b5c48cec25d06d3cc7a48979ee2eb2b0e0e9` route T5/T6/T8/T12 through the same update reducer as `update(frame:)`; final implementation `981ff4e208f74c8d4dd451d32df88233089e3201` defines the confidence input initializer explicitly and initializes its cooldown `let` exactly once after two exact-SHA Swift host type-check failures exposed the synthesized/default-property mismatch. A new exact-final-SHA CI run and independent re-review are mandatory; earlier runs cannot qualify this newer SHA.
