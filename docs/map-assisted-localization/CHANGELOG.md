...
- 聚焦验证为 ESL capture/finalization Swift host PASS、ARFrame-only source contract PASS、Stage-3 + localized-output-store 104/104 PASS。I5 还完成 `IOSCoreContractTests.test_swift_workflow_state_and_se2_projection` 943.159 s PASS、iOS/C4 12/12、Map Studio 106/106 与 P0 4/4。Xcode 已编译本轮 Swift module，但本机完整 simulator build 仍因 platform-scoped Eigen/PCL/OpenCV headers 缺失而 FAIL；不能写本机 clean build PASS。
