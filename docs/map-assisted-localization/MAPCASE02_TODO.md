...
- 完整运行 `IOSCoreContractTests.test_swift_workflow_state_and_se2_projection`；2026-08-09 已通过 300k finalization 与 1,728,000 trace 阶段，主动停在超长 `tag-evidence-scale`，不能登记为本轮完整 PASS。
