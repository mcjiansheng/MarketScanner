...
| Partial Result / legacy RESCAN | 非 PASS 有限轨迹提交 immutable Result、`publish_permitted=false`、不完整 burst 保留条码；Full solver failure 回退 Fast partial；Result publish intent/crash recovery；legacy RESCAN strict parser，零有限轨迹保留 terminal artifact | 最终完整 Swift host **1/1 PASS（1250.897 s）**；真机 NOT RUN |
