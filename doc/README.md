# RTAB-Map 上游 README 归档

> 文档状态：**上游快照归档**。归档状态最后核对日期：2026-07-20。下方内容来自本仓库初始 RTAB-Map README，仅用于保留上游说明，不代表 MarketScanner 当前功能、版本状态或构建入口；项目当前说明以仓库根目录 `README.md` 为准。
