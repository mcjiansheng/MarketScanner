...
CONTRACT = {
    ...
    "product_scale": {
        ...
        "max_pose_epoch_transitions": 60000,
        "max_corridor_hypotheses": 60000,
        "max_shelf_observation_windows": 60000,
        "max_shelf_loop_events": 60000,
    ...
    "evidence_files": {
        ...
        "pose_epoch_transitions.jsonl": {
            ...
            "strict_bool": True,
            "strict_integer": True,
            "identity_fields": ["tracking_session_id", "sequence",
                                "from_epoch", "to_epoch"],
            "watermark_fields": ["poseEpochTransitionCount",
                                 "poseEpochTransitionLastSequence"],
        },
        "corridor_hypotheses.jsonl": {
            # Accepted-node cadence is bounded by the 60k-node product scale.
            "max_file_bytes": 256 * 1024 * 1024,
            "max_records": 60000,
            "qualification_max_records": 60000,
            "qualification_record_rate_hz": 2,
            ...
            "strict_bool": True,
            "strict_integer": True,
            "identity_fields": ["tracking_session_id", "node_id", "epoch",
                                "component", "sequence"],
            "watermark_fields": ["corridorHypothesisCount",
                                 "corridorHypothesisLastSequence"],
        },
        "shelf_observation_windows.jsonl": {
            ...
            "strict_bool": True,
            "strict_integer": True,
            "identity_fields": ["tracking_session_id", "window_id", "epoch",
                                "component", "prior_map_sha256", "sequence"],
            "watermark_fields": ["shelfObservationWindowCount",
                                 "shelfObservationWindowLastSequence"],
        },
        "shelf_loop_events.jsonl": {
            ...
            "strict_bool": True,
            "strict_integer": True,
            "identity_fields": ["tracking_session_id", "shelf_segment_id",
                                "epoch", "component", "sequence"],
            "watermark_fields": ["shelfLoopEventCount",
                                 "shelfLoopEventLastSequence"],
        },
        "result_package": {
